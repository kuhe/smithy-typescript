...
public class SchemaTraitGenerator {
    private static final String BOOLEAN_TRAIT_VALUE = "1";
    private static final String ANNOTATION_TRAIT_VALUE = "2";
    private static final Set<Class<? extends Trait>> ANNOTATION_TRAITS = SetUtils.of(
    ...
    private static final Set<Class<? extends Trait>> BOOLEAN_TRAITS = SetUtils.of(
    ...
    public String serializeTraitData(Trait trait, StringStore stringStore) {
        ...
        } else if (BOOLEAN_TRAITS.contains(trait.getClass())) {
            return BOOLEAN_TRAIT_VALUE;
