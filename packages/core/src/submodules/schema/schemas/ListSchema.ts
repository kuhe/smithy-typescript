import type { ListSchema as IListSchema, SchemaRef } from "@smithy/types";
...
export function list(name: string, traits: Record<string, any> = {}, valueSchema: SchemaRef = void 0): ListSchema {
